...
from ObjectDetection.PreprocessingRPi import ReadAnchors, ReadClasses, PreprocessImageWithPIL, PreprocessImageHybrid, ScaleBoxes, GenerateColors, DrawBoxes
...
def PredictNetwork(sess, yoloModel, FRModel, database, image, classNames, scores, boxes, classes):
    ...
    '''
    try:
        image, imageData = PreprocessImageWithPIL(image, modelImageSize = (608, 608))
